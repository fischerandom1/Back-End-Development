...
class FastSAMPrompt:
    ...
    # Remark for refactoring: IMO a function should do one thing only, storing the image and plotting 
    # should be seperated and do not necessarily need to be class functions but standalone utility 
    # functions that the user can chain in his scripts to have more fine-grained control. 
    def plot(self,
             annotations,
             output_path,
             bboxes=None,
    ...
    def text_prompt(self, text):
        ...
        # print(max_idx)
        return np.array([annotations[max_idx]['segmentation']]), np.array(annotations[max_idx]['bbox']), annotations[max_idx]['score']
